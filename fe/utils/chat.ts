...
export async function getAnswer(question: string): Promise<ChatMessage> {
    ...
    const SYSTEM_TEMPLATE = `Use the following pieces of context to answer the question at the end.
        ...
        3. If you don't know the answer and the question is not relevant to furniture, try suggesting other furniture relevant questions, don't try to make up an answer or answer anything isn't relevant to furniture or context.
        4. No directly mention any specific person in the answer.
      ----------------
      {context}`;
